...
class _PLVideoPlayerState extends State<PLVideoPlayer>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (!plPlayerController.continuePlayInBackground.value) {
      // Don't pause when PiP is active — the system PiP window is handling
      // playback and the Flutter app going to background is expected.
      if (Platform.isOhos && OhosPipHelper.isInPip.value) return;
