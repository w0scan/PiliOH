...
abstract final class Pref {
  ...
  // OHOS native dual-AVPlayer player. Off by default; only meaningful on OHOS.
  static bool get useNativePlayer =>
      Platform.isOhos &&
      _setting.get(SettingBoxKey.useNativePlayer, defaultValue: false);

  // Sync master track for the native dual player: 0 = audio (default), 1 = video.
  static int get nativeSyncMaster =>
      _setting.get(SettingBoxKey.nativeSyncMaster, defaultValue: 0);
