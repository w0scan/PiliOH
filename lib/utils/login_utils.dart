...
abstract final class LoginUtils {
  static FutureOr setWebCookie([Account? account]) {
    // flutter_inappwebview has no Linux/OHOS implementation; CookieManager
    // .instance would dereference a null WebViewPlatform and throw.
    if (Platform.isLinux || Platform.isOhos) {
      return null;
    }
